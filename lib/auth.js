...
class Auth {
  ...
  /// A token given through the environment (MC_OWNER_TOKEN, MC_AGENT_TOKEN): makes hosts
  ...
  /// Tokens created while the org runs, by `node server.js token <name>` on the org machine,
